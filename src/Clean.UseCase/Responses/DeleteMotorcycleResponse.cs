...
// FILE: DeleteMotorcycleResponse.cs
...
namespace Clean.UseCase.Responses
{
    ...
    /// <summary>   A delete motorcycle response. </summary>
    public sealed class DeleteMotorcycleResponse
    {
        #region Properties
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// <summary>   ID will be set to the value that was requested to be deleted. </summary>
        ///
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// <summary>   Creates a new delete motorcycle response. </summary>
        ///
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        public static (DeleteMotorcycleResponse response, IError error) NewDeleteMotorcycleResponse(long id, OperationStatus status, IError error)
        {
            ...
            var response = new DeleteMotorcycleResponse
            {
                Id = id,
                Status = status,
                Error = error
