...
// FILE: PostMotorcycleResponse.cs
...
namespace Clean.UseCase.Responses
{
    ...
    /// <summary>   A post motorcycle response. </summary>
    public sealed class PostMotorcycleResponse
    {
        #region Properties
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// <summary>   ID will be set to the value that was requested to be postd. </summary>
        ///
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// <summary>   Creates a new post motorcycle response. </summary>
        ///
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        public static (PostMotorcycleResponse response, IError error) NewPostMotorcycleResponse(long id, OperationStatus status, IError error)
        {
            ...
            var response = new PostMotorcycleResponse
            {
                Id = id,
                Status = status,
                Error = error
